...
<script type="text/javascript">
	...
	$(function() {
		...
		$("#login-submit-btn").on("click", function() {
			...
			if (!/^\w{3,20}$/.test(loginname)) {
				msg = "Ada提醒您，您的登录名长度需要是3~20之间";
			} else if (!/^\w{3,20}$/.test(password)) {
				msg = "Ada提醒您，您的密码长度必须是3~20之间";
			}
			if (msg != "") {
	...
	<div class="page-lock">
		<div class="page-logo" style="margin-bottom: 2px">
			<a class="brand" href="login.html"
				style="font-size: 22px; color: #FFF;"> 大黄来管人<span
			...
			<div class="page-body">
				...
				<div class="page-lock-info">
					...
					<c:choose>
						...
						<c:otherwise>
							<span style="padding-top: 5px color:red">${requestScope.message}</span>
						</c:otherwise>
					</c:choose>
