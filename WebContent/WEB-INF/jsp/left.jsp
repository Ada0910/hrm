...
<body>
	<div style="margin:10px;background-color:#FFFFFF; text-align:left;">
		<table style="width:200px ,height:100%" border="0" cellpadding="0"
				...
				<td class="left_nav_bgshw" height="50">
					<p class="left_nav_link">
						<img src="${ctx}/images/left_nav_arrow.gif" />&nbsp;&nbsp;<a
							href="user/selectUser" target="main">用户查询</a>
					</p>
					<p class="left_nav_link">
						<img src="${ctx}/images/left_nav_arrow.gif" />&nbsp;&nbsp;<a
							href="user/addUser?flag=1" target="main">添加用户</a>
					</p>
				</td>
			</tr>
			...
			<tr valign="top" id="submenu1" style="display: none">
				<td class="left_nav_bgshw" height="50">
					<p class="left_nav_link">
						<img src="${ctx}/images/left_nav_arrow.gif" />&nbsp;&nbsp;<a
							href="dept/selectDept" target="main">部门查询</a>
					</p>
					<p class="left_nav_link">
						<img src="${ctx}/images/left_nav_arrow.gif" />&nbsp;&nbsp;<a
							href="dept/addDept?flag=1" target="main">添加部门</a>
					</p>
				</td>
			</tr>
			...
			<tr valign="top" id="submenu2" style="display: none">
				<td class="left_nav_bgshw" height="50">
					<p class="left_nav_link">
						<img src="${ctx}/images/left_nav_arrow.gif" />&nbsp;&nbsp;<a
							href="job/selectJob" target="main">职位查询</a>
					</p>
					<p class="left_nav_link">
						<img src="${ctx}/images/left_nav_arrow.gif" />&nbsp;&nbsp;<a
							href="job/addJob?flag=1" target="main">添加职位</a>
					</p>
				</td>
			</tr>
			...
			<tr valign="top" id="submenu3" style="display: none">
				<td class="left_nav_bgshw" height="50">
					<p class="left_nav_link">
						<img src="${ctx}/images/left_nav_arrow.gif" />&nbsp;&nbsp;<a
							href="${ctx }/employee/selectEmployee" target="main">员工查询</a>
					</p>
					<p class="left_nav_link">
						<img src="${ctx}/images/left_nav_arrow.gif" />&nbsp;&nbsp;<a
							href="${ctx }/employee/addEmployee?flag=1" target="main">添加员工</a>
					</p>
				</td>
			</tr>
			...
			<tr valign="top" id="submenu4" style="display: none">
				<td class="left_nav_bgshw tdbtmline" height="50">
					<p class="left_nav_link">
						<img src="${ctx}/images/left_nav_arrow.gif" />&nbsp;&nbsp;<a
							href="${ctx }/notice/selectNotice" target="main">公告查询</a>
					</p>
					<p class="left_nav_link">
						<img src="${ctx}/images/left_nav_arrow.gif" />&nbsp;&nbsp;<a
							href="${ctx }/notice/addNotice?flag=1" target="main">添加公告</a>
					</p>
				</td>
			</tr>
			<tr>
			...
			<tr>
				<td id="navbg5" class="left_nav_closed"  onclick="showsubmenu(5)"><div
						class="font1">下载中心</div></td>
			</tr>
			<tr valign="top" id="submenu5" style="display: none">
				<td class="left_nav_bgshw tdbtmline" height="50">
					<p class="left_nav_link">
						<img src="${ctx}/images/left_nav_arrow.gif" />&nbsp;&nbsp;<a
							href="${ctx }/document/selectDocument" target="main">文档查询</a>
					</p>
					<p class="left_nav_link">
						<img src="${ctx}/images/left_nav_arrow.gif" />&nbsp;&nbsp;<a
							href="${ctx }/document/addDocument?flag=1" target="main">上传文档</a>
					</p>
				</td>
			</tr>
			<tr>
			...
			<tr valign="top">
				<td height="100%" align="center"><div class="copycct">
						<img src="${ctx }/images/love.gif" height="180" width="180"/>
					</div></td>
			</tr>
			<tr>
				<td height="10"><img src="${ctx}/images/left_nav_bottom.gif"
					height="10"></img></td>
			</tr>
			<tr>
