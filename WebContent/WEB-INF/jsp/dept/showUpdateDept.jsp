		  ...
		  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
		    <tr><td class="font3 fftd">
		    	<table>
		    		...
		    		<tr>
		    			<td class="font3 fftd">部门描述：<input type="text" name="remark" id="remark" size="20" value="${dept.remark }"/></td>
			...
			<tr><td align="left" class="fftd"><input type="submit" value="修改">&nbsp;&nbsp;<input type="reset" value="重置 ">&nbsp;&nbsp;<input type="button" value="返回"
