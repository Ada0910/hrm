...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
	...
	<td class="main_locbg font2">当前位置：员工管理  &gt; 修改员工</td>
		  ...
		  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
		    <tr><td class="font3 fftd">
		    	<table>
		    		...
		    		<tr>
		    			<td class="font3 fftd">学&nbsp;&nbsp;&nbsp;历：<input name="education" id="education" size="20" value="${employee.education }"/></td>
		    			 </tr>
					    <tr>
		    			<td class="font3 fftd">邮&nbsp;&nbsp;&nbsp;箱：<input name="email" id="email" size="20" value="${employee.email }"/></td>
		    		</tr>
		    		<tr>
		    			<td class="font3 fftd">手&nbsp;&nbsp;&nbsp;机：<input name="phone" id="phone" size="20" value="${employee.phone }"/></td>
		    			 </tr>
					    <tr>
			...
			<tr>
				<td class="font3 fftd">
					政治面貌：&nbsp;<input name="party" id="party" size="20" value="${employee.party }"/>
</td> </tr>
					    <tr ><td class="font3 fftd">
					QQ号码：&nbsp;<input name="qqNum" id="qqNum"  size="20"value="${employee.qqNum }"/>
				</td>
			</tr>
			<tr><td class="main_tdbor"></td></tr>
			...
			<tr>
				<td class="font3 fftd">
					联系地址：&nbsp;<input name="address" id="address" size="40" value="${employee.address }"/></td> </tr>
					    <tr><td class="font3 fftd">
					邮政编码：&nbsp;<input name="postCode" id="postCode"  value="${employee.postCode }"/>
				</td>
			</tr>
			<tr><td class="main_tdbor"></td></tr>
			...
			<tr>
				<td class="font3 fftd">
					...
					name="birthday" id="birthday" size="20"/></td> </tr>
					    <tr><td class="font3 fftd">
			...
			<tr>
				<td class="font3 fftd">
					所学专业：&nbsp;<input  name="speciality" id="speciality" size="20" value="${employee.speciality }"/></td> </tr>
					    <tr><td class="font3 fftd">
			...
			<tr><td align="left" class="fftd"><input type="submit" value="修改">&nbsp;&nbsp;<input type="reset" value="重置 ">&nbsp;&nbsp<input type="button" value="返回" onclick="javascript:history.go(-1);"></td></tr>
		  </table>
		 </form>
	</td>
  </tr>
