...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
	...
	<td class="main_locbg font2">当前位置：员工管理  &gt; 添加员工</td>
		  ...
		  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
		    <tr><td class="font3 fftd">
		    	<table>
		    		...
		    		<tr><td class="font3 fftd">身份证号码：<input type="text" name="cardId" id="cardId" size="20"/></td></tr>
		    		<tr>
		    		...
		    		<tr>
		    			<td class="font3 fftd">学&nbsp;&nbsp;&nbsp;历：<input name="education" id="education" size="20"/></td>
		    			</tr>
		    			<tr>
		    			<td class="font3 fftd">邮&nbsp;&nbsp;&nbsp;箱：<input name="email" id="email" size="20"/></td>
		    		</tr>
		    		<tr>
		    			<td class="font3 fftd">手&nbsp;&nbsp;&nbsp;机：<input name="phone" id="phone" size="20"/></td>
		    			</tr>
		    			<tr>
			...
			<tr>
				<td class="font3 fftd">
					政治面貌：&nbsp;<input name="party" id="party" size="20"/></td>
					</tr>
					<tr>
					<td class="font3 fftd">
					QQ&nbsp;号码：<input name="qqNum" id="qqNum" />
				</td>
			</tr>
			<tr><td class="main_tdbor"></td></tr>
			...
			<tr>
				<td class="font3 fftd">
					联系地址：<input name="address" id="address" size="40"/></td>
					</tr>
					<tr><td class="font3 fftd">
			...
			<tr>
				<td class="font3 fftd">
					...
					name="birthday" id="birthday" size="20"/></tr>
					<tr>
					<td class="font3 fftd"> 
			...
			<tr>
				<td class="font3 fftd">
					所学专业：&nbsp;<input  name="speciality" id="speciality" size="20"/></tr>
					<tr>
					<td class="font3 fftd"> 
